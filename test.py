...
# Page configuration
st.set_page_config(
    page_title="Quirky Analytics - Lead Generation Agent",
    page_icon="📊",
    layout="wide"
)
...
def generate_pdf_report(company_name: str, fit_data: Dict, pain_data: Dict = None) -> bytes:
    ...
    if pain_data:
        ...
        # Solutions Section
        story.append(Paragraph("How Quirky Analytics Can Help", heading_style))
    ...
    story.append(Paragraph("Generated by Quirky Analytics Lead Generation Agent | Powered by Claude AI", footer_style))
...
def analyze_company_fit(
    ...
    prompt = f"""You are a lead qualification analyst for Quirky Analytics, a consulting company specializing in data science, AI, and business intelligence.
...
def generate_pain_point_analysis(
    ...
    prompt = f"""You are a business development analyst for Quirky Analytics, specializing in data science, AI, and analytics consulting.
...
# UI Layout
st.title("📊 Quirky Analytics - Lead Generation Agent")
...
with st.sidebar:
    ...
    our_services = st.text_area(
        "Describe Quirky Analytics services",
...
st.markdown(
    ...
    <div style='text-align: center'>
        <p>Powered by Claude Sonnet 4 | Built for Quirky Analytics</p>
